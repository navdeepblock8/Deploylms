...
const ds_datasource_config_json_1 = __importDefault(require("./ds.datasource.config.json"));
...
DsDataSource = __decorate([
    core_1.lifeCycleObserver('datasource'),
    __param(0, core_1.inject('datasources.config.ds', { optional: true })),
